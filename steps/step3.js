...
function move(e) {
  ...
  function initialClick(e) {
    ...
    if (movable.moving == true) {
      if (movable.isInPlace == true) {
        ...
        text_area.value = "Jahuti on õigel kohal, võib edasi liikuda."
  ...
  function infoClick(e) {
    ...
    var desc = get_description(e)
    image = this;
    text_area.value = lang[localStorage.getItem('lang')][':not_cooling']+desc+lang[localStorage.getItem('lang')][':other_part']
  }
  ...
  window.onload = function () {
    var text_area = document.querySelector("#text")
    text_area.value = lang[localStorage.getItem('lang')][':step_3']
