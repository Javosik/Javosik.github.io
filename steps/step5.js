...
function move(e) {
  ...
  function infoClick(e) {
    ...
    var desc = get_description(e)
    image = this;
    text_area.value = lang[localStorage.getItem('lang')][':not_hdd']+desc+lang[localStorage.getItem('lang')][':other_part']
  }
  ...
  window.onload = function () {
    var text_area = document.querySelector("#text")
    text_area.value = lang[localStorage.getItem('lang')][':step_5']
